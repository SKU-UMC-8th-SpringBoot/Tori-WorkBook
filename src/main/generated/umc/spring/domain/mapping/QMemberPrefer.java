...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    public final umc.spring.domain.entity.QFoodCategory category;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new umc.spring.domain.entity.QFoodCategory(forProperty("category")) : null;
